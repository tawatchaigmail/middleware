...
*/
 ...
 async function reportFileMaster(param) {  
                                            try {
                                                 ...
                                                 var reportFileMaster = await knex('REPORT_FILE_MASTERS').where(param).select();
 ...
 module.exports = data = {
                          getAll : async () => {
                                            try {
                                                 ...
                                                 var dataAll = await knex('REPORT_FILE_MASTERS').select();
                                                 return dataAll;
                                                 } catch (e) {
                                                   console.log(e);
                                                   return e ; 
                           ...
                           getById : async (param) => {
                                            try {
                                                 ...
                                                 var dataById = await knex('REPORT_FILE_MASTERS').where("REPORT_ID",param).select();
                                                 return dataById;
                                                 } catch (e) {
                                                   console.log(e)
                                                   return e ; 
                            ...
                            create : async (param) => {
                                             try {
                                                 ...
                                                 const dataCreate = await knex("REPORT_FILE_MASTERS").insert(param);
                                                 return dataCreate;
                                                 } catch (e) {
                                                   console.log(e);
                                                   return e ; 
                            ...
                            update : async (id, param) => {
                                             try {
                                                 ...
                                                 const dataUpdate = await knex("REPORT_FILE_MASTERS").where("REPORT_ID", id).update(param);
                                                 return dataUpdate;
                                                 } catch (e) {
                                                   console.log(e);
                                                   return e ; 
                            ...
                            delete : async (param) => {
                                                 try {
                                                 const dataDelete = await knex("REPORT_FILE_MASTERS").where("REPORT_ID", param).del();
                                                 return dataDelete;
                                                 } catch (e) {
                                                   console.log(e)
                                                   return e ; 
